import {
  ...
  const experiences = [
    ...
    },
    {
      ...
      date: "Summer 2024",
      points: [
        "Created and tailored an Active Directory environment.",
        "Led penetration testing on the environment to extract weaknesses.",
        "Proposed solutions and guidelines to boost security",
      ],
    },
      {
      title: "Internship",
      ...
      date: "Summer 2025",
      points: [
        "Development of a system that allows:",
        "• Implementing the NIST Framework: Identify, Protect, Detect, Respond, Recover, Govern, modules",
        "• Generating the risk treatment path",
        "• Ensuring reporting during the assessment and action plan development stages",
      ],
    },
  ];
